...
main(int argc, char* argv[])
{
    ...
    if(NS_select == 0){
        ...
        apiPort = 1885;
        token = "NNSXS.WVHEPIVWEOCD6S3ASGV265XT6WCOKGKBWPE45OQ.UEPDJCTY4NKRZHNEDHRMDRWASIEV2SWKJT7IGTZVVMXOAQHQG2XQ";
